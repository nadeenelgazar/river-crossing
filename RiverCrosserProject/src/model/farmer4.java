...
public class farmer4 extends SubScene {
...
//ICrosser farmer = factory.getcrosser("farmer");
	public farmer4(ICrosser farmer) {
		...
		prefWidth(600);
		prefHeight(400);
		BackgroundImage image = new BackgroundImage(new Image(backimage, 50, 50, false, true),
	...
	EventHandler<MouseEvent> circleOnMouseDraggedEventHandler = new EventHandler<MouseEvent>() {
		...
		@Override
		public void handle(MouseEvent t) {
			// if(orgSceneX-orgTranslateX>-278)
			// {transition.setToX(-300);transition.setToY(6);transition.play();z=transition.getToX();}
