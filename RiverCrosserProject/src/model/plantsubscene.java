...
double orgTranslateX, orgTranslateY;
	...
	public plantsubscene(ICrosser plant) {
		...
		prefWidth(600);
		prefHeight(400);
		BackgroundImage image=new BackgroundImage(new Image(backimage,20,20,false,true), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, null);
